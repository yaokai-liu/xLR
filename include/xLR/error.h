...
enum XLR_ERROR_CODE_ENUM {
  ...
  XLR_ERROR_NUMBER_OF_ARGUMENTS_MISMATCH,
  XLR_ERROR_ACCESS_NONE_FIELD_TYPE,
  XLR_ERROR_CALLED_NOT_A_FUNCTION,
  XLR_ERROR_NO_SUCH_ATTRIBUTE,
  XLR_ERROR_NO_SUCH_VARIABLE,
  XLR_ERROR_MULTI_DEFINITION,
  XLR_ERROR_NO_SUCH_FIELD,
  XLR_ERROR_TYPE_MISMATCH,
};
