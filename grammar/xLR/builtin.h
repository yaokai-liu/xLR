...
enum XLR_BUILTIN_FUNC_ENUM : uint32_t {
  XLR_BUILTIN_FUNC_ATTRS_GET,
  XLR_BUILTIN_FUNC_ATTRS_SET,
  XLR_BUILTIN_FUNC_ARRAY_GET,
  XLR_BUILTIN_FUNC_ARRAY_SET,
